        ...
        <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
          ...
          <div>
            <p>
              ...
              attained a senior-level position due to my exceptional reliability
              and unwavering focus in the workplace. Throughout my professional
              journey, I have cultivated valuable skills that have proven to be
              instrumental in achieving successful outcomes, including:
            </p>
            <ul className='list-disc list-inside indent-4 text-sm'>
              <li>
                Strong ability to work effectively as part of a
                teamto accomplish common goals.
              </li>
              <li>
              ...
              <li>
                Being a highly dependable resource and asset and meeting expectations consistently.
              </li>
              <li>
              Keen organizational abilities
              </li>
            </ul>
